...
///FeatherstoneIntegratorDemo is good starting point for learning the code base and porting.
...
class FeatherstoneIntegratorDemo : public PlatformDemoApplication
{
	...
	FeatherstoneIntegratorDemo()
		:m_pickingMultiBodyPoint2Point(0)
	{
	}
	virtual ~FeatherstoneIntegratorDemo()
	{
		exitPhysics();
	}
	void	initPhysics();
	...
	{
		FeatherstoneIntegratorDemo* demo = new FeatherstoneIntegratorDemo;
		demo->myinit();
		demo->initPhysics();
		return demo;
	}
